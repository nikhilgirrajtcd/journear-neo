package com.journear.app.map.map;
...
import com.journear.app.map.GHAsyncTask;
...
import com.journear.app.map.activities.ShowLocationActivity;
import com.journear.app.map.model.listeners.MapHandlerListener;
import com.journear.app.map.navigator.NaviEngine;
import com.journear.app.map.utils.TargetDirComputer;
...
{
    MapActivity mapActivityold = new MapActivity();
    ...
    public void init(MapView mapView, String currentArea, File mapsFolder)
    {
        ...
        //mapActivityold.initFiles(currentArea);
     ...
     * @param areaFolder
     */
    public void loadMap(File areaFolder, MapNewActivity activity)
    {
        ...
        //mapActivityold.loadGraphStorage(activity);
        loadGraphStorage(activity);
    }

    void loadGraphStorage(final MapNewActivity activity) {
